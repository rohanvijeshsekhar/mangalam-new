...
const servicePages = [
  ['attraction.html', 'Attractions', 'Top attraction tickets and activities',
   `<main class="min-h-screen"><div class="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-16 px-4 text-center"><h1 class="text-4xl font-bold font-[Quicksand] mb-2">Attractions</h1><p class="text-gray-300 font-dm-sans">Experience the world's top attractions</p></div><section class="py-12 container mx-auto px-4"><div id="attractions-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"><div class="col-span-full text-center py-20 text-gray-400">Loading...</div></div></section></main>`,
   'attractions.js'],
