...
const servicePages = [
  ['attraction.html', 'Attractions', 'Top attraction tickets and activities',
   `<main class="min-h-screen"><section class="relative h-[48vh] min-h-[380px] overflow-hidden"><div class="absolute inset-0"><img src="./assets/images/activity-banner.webp" alt="Activities Banner" class="hidden lg:block w-full h-full object-cover rounded-br-[120px] md:rounded-br-[150px]"><img src="./assets/images/res-activity-banner.webp" alt="Activities Banner Mobile" class="lg:hidden w-full h-full object-cover rounded-br-[120px]"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-black/20 rounded-br-[120px] md:rounded-br-[150px]"></div></div><div class="relative z-10 h-full flex items-end"><div class="container mx-auto px-4 pb-12"><h1 class="text-3xl md:text-5xl font-bold text-white font-[Quicksand] leading-tight drop-shadow-lg">Activities for Every Traveler</h1><p class="text-white/90 text-sm md:text-base mt-2 font-dm-sans max-w-xl drop-shadow">Experience the world's top attractions, entry tickets and unforgettable experiences</p></div></div></section><section class="py-12 container mx-auto px-4"><div id="attractions-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"><div class="col-span-full text-center py-20 text-gray-400">Loading...</div></div></section><section id="poster-section" class="relative z-0 py-6 lg:py-10 container mx-auto px-4" style="display:none"><div id="posterCarousel" class="splide"><div class="splide__track"><ul id="poster-list" class="splide__list"></ul></div></div></section></main>`,
   'attractions.js'],
