<?php
function ticketCard($prop)
{
    extract($prop);
?>

    <a href="./tickets-details.php?slug=<?php echo urlencode($slug_url); ?>" class="activity-card">
        <div class="thumbnail">
            <div class="cta">
                ...
                <img src="./assets/images/icons/new/menu/tickets-active.png" alt="">
            </div>
            <img loading="lazy" src="./admin/files/tickets/<?php echo $image; ?>" alt="" class="thumbnail-img">
        </div>
        <div class="content">
